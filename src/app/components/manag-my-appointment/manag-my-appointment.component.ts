...
@Component({
  selector: 'app-manag-my-appointment',
  templateUrl: './manag-my-appointment.component.html',
  styleUrls: ['./manag-my-appointment.component.scss']
})
export class ManagMyAppointmentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.appser.GetAppByUser().subscribe((date) => {
